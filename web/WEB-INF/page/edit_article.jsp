...
<div class="main">
    <form action="edit.do" method="post" onsubmit="return checkSubmit()">
        <input type="hidden" name="article_id" value="${articleToEdit.article_id}">
        <div class="title">
            <input autocomplete="off" id="input-title" type="text"
                   name="article_title" maxlength="200" placeholder="在此处添写文章标题" value="${articleToEdit.article_title}" >
        </div>
        <div class="content">
            <div id="editormd">
                <textarea id="input-content" name="article_content"  style="display:none;">${articleToEdit.article_content}</textarea>
            </div>
        </div>
        <div class="kind">
            <p>文章分类:</p>
...
<div class="hidden-space">
    <p id="article_id">${articleToEdit.article_id}</p>
    <p id="article_tag">${articleToEdit.article_tag}</p>
    <p id="article_kind">${articleToEdit.article_kind}</p>
    <p id="is_private">${articleToEdit.is_private}</p>
